    ...
    return <div className="panel panel-default control-header-style">
      <div className="panel-heading">
        <h4 className="panel-title">
          <a data-toggle="collapse" data-parent={this.getAccordianId()} href={this.getHref()}>
            R. {this.props.answer.get('title')}</a>
        </h4>

      </div>
      <div id={this.props.answer.get('id')} className="panel-collapse collapse in">
